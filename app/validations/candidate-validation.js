const Candidate = require('../models/candidate-model') // Profile creation.
const candidateValidationSchema = {
    userId: { // for security purpose we will be extracting id from req.obj. 
        custom: {
            options: async function(value, { req }){ // if the user is not providing a value we will be extracting it from req.obj and passing it as a second argument.
